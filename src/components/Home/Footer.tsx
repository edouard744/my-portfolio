...
export default function Footer({ t }: { t: any }) {
  return (
    <footer className="bg-blue-900 overflow-hidden px-4 pb-24 text-white md:px-8">
      ...
      <div className="mx-auto mb-14 flex max-w-7xl gap-4 border-b-2 px-10 pt-10 pb-4 lg:px-0 items-center">
      <svg
        width={50}
        height={50}
        viewBox="0 0 48 48"
      ...
      >
        ...
        <span className="text-2xl font-semibold">Willems Edouard</span>
      </div>

      <div className="mx-auto mb-10 flex max-w-7xl flex-col px-10 md:flex-row md:justify-between lg:px-0">
        <div className="mb-10 flex flex-col justify-center gap-6 md:justify-start">
        ...
        <div className="flex mb-10 min-w-32 flex-col gap-4 pb-4">
      ...
      <div className="mx-auto mb-10 flex max-w-7xl flex-col justify-center gap-6 border-t-2 px-10 py-10 md:mb-0 md:flex-row md:items-center md:justify-end lg:justify-between lg:px-0">
