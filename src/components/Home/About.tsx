  ...
  return (
    <section className="text-gray-50 bg-gray-900 flex flex-col items-center">
      ...
      <div className="max-w-7xl grid lg:grid-cols-3 lg:grid-rows-[min-content_1fr] py-20 mx-8">
        ...
        <div>
          <h3 className="text-2xl mb-4 font-semibold">{t.about.skills.first}</h3>
          <div className="mb-6">
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-2">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/laravel/laravel-original.svg" alt="PHP Laravel" className="w-5 h-5" />
                <span>PHP / Laravel</span>
              </li>
              <li className="flex items-center gap-2">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg" alt="SQL" className="w-5 h-5" />
...
<div className=" ">
          <h3 className="text-2xl mb-4 font-semibold">{t.about.skills.second}</h3>
          <ul className="space-y-4 mb-6">
            ...
            <li className="flex items-center gap-2">
              <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-original.svg" alt="Photoshop" className="w-5 h-5" />
            ...
            <li className="flex items-center gap-2">
              <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-plain.svg" alt="Docker" className="w-5 h-5" />
              <span>Docker</span>
            </li>
          </ul>
</div>
<div>
          ...
          <span className="text-2xl mb-4 block font-semibold">{t.about.skills.third}</span>
        ...
        <div className="flex  flex-col lg:row-span-2 pt-10 border-t-2 lg:border-t-0 border-gray-50 border-dotted">
          <span className="font-semibold text-2xl mb-6">{t.about.skills.info.title}</span>
          <div className="flex flex-col gap-4">
