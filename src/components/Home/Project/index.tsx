    ...
    <section className="relative bg-white py-32">
      <div className="w-full max-w-7xl lg:mx-auto lg:max-w-5xl px-4">
        ...
        <div className="mb-20 flex flex-col items-center justify-center gap-6 lg:flex-row">
          <ProjectCard
            image={PressionProPic}
            title={t.projects.pressionpro.title}
            description={t.projects.pressionpro.description}
            alt={t.projects.pressionpro.alt}
            techno={t.projects.pressionpro.techno}
            aria={t.projects.aria}
          />
          <ProjectCard
            image={PressionProPic}
            title="PressionPro"
            description="Création d'un site pour un indépendant en nettoyage haute pression"
            alt="Projet Pression Pro"
            techno={["NextJs", "TailwindCSS", "ReactJs"]}
            aria="Projet Pression Pro"
          />
        </div>
      </div>
    </section>
